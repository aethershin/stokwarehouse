...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2023 at 02:55 AM
...
CREATE TABLE `tbl_add_stock` (
  ...
  `jumlah_add_stock` int(255) DEFAULT NULL,
  `biaya_dikeluarkan` int(255) DEFAULT NULL,
...
CREATE TABLE `tbl_cicil` (
  ...
  `cicilan` int(255) DEFAULT NULL,
  `telah_dibayar` int(255) DEFAULT 0,
  `jumlah_telah_dibayar` int(255) DEFAULT 0,
  `jumlah_cicilan` int(255) DEFAULT NULL,
...
CREATE TABLE `tbl_list_transaksi` (
  ...
  `jumlah_pembelian` int(255) DEFAULT NULL,
  `jumlah_dibayar` int(255) DEFAULT NULL,
  `jenis_transaksi` varchar(255) DEFAULT NULL,
  `total_belanja` int(255) DEFAULT NULL,
  `dapatkan_hutang` int(255) DEFAULT NULL,
  `tenorbulan` varchar(255) DEFAULT NULL,
  `tenorcicil` int(255) DEFAULT NULL,
...
CREATE TABLE `tbl_produksi_selesai` (
  ...
  `produksi_selesai_jumlah` int(255) DEFAULT NULL,
  `produksi_selesai_biaya` int(255) DEFAULT NULL,
...
CREATE TABLE `tbl_rekap_cash` (
  ...
  `total_cash` int(255) DEFAULT NULL,
...
CREATE TABLE `tbl_selesai_add_stock` (
  ...
  `add_stock_jumlah` int(255) DEFAULT NULL,
...
CREATE TABLE `tbl_stock_produksi` (
  ...
  `stock_minimal` int(255) DEFAULT NULL,
  `nilai_saham` int(255) DEFAULT NULL,
  `tgl_tambah` timestamp NULL DEFAULT current_timestamp(),
  `tgl_ubah` timestamp NULL DEFAULT current_timestamp(),
  `user_id_stock` int(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_surat_jalan` (
  ...
  `jumlah_surat_jalan` int(255) DEFAULT NULL,
...
CREATE TABLE `tbl_transaksi` (
  ...
  `bahan_baku_id` varchar(255) DEFAULT NULL,
  `jumlah_transaksi` int(255) DEFAULT NULL,
  `jumlah_laku` int(255) DEFAULT 0,
  `harga_jual_konsumen` int(255) DEFAULT NULL,
  `harga_jual_laku` int(255) DEFAULT 0,
  `harga_jual_transaksi` int(255) DEFAULT NULL,
  `harga_modal_transaksi` int(255) DEFAULT NULL,
...
(1, 'Zikry', 'zikryafwan@gmail.com', '21232f297a57a5a743894a0e4a801fc3', '1', '1', '6490f08e2576121fa59f189ea099e0d2.webp'),
