...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <p class="auth-subtitle mb-5 display-4">Halo </br><span><?php echo $nama; ?></p>
            <h2>Reset Password Anda</h2>
            
            <?php 
                echo form_open('login_user/change');
            ?>
                <?php echo $this->session->flashdata('msg');?>
                <input  type="hidden" name="r3s3t_k3y" value="<?php echo $reset_key; ?>">
