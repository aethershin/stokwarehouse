...
class Rekap_nota_transaksi_konsumen_model extends CI_Model{
    ...
    function get_detail_nota($id){
		$this->db->select("tbl_list_transaksi.*, nama,catatan,cicilan,telah_dibayar,jumlah_telah_dibayar,tgl_update_bayar,jumlah_laku,harga_jual_laku,user_name, SUM(IF(kode_transaksi_list=kode_transaksi, jumlah_laku, 0)) AS totals");
